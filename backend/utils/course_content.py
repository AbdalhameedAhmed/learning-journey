course_content = [
    {"id": 1, "type": "lesson", "name": "الاهداف"},
    {"id": 2, "type": "lesson", "name": "الدرس الاول"},
    ...
    {"id": 17, "type": "exam", "name": "امتحان الوحدة الاول", "next_exam_index": 13},
    {"id": 11, "type": "lesson", "name": "الاهداف"},
    {"id": 12, "type": "lesson", "name": "الدرس الاول"},
    ...
    {"id": 22, "type": "exam", "name": "امتحان الوحدة الثانى", "next_exam_index": 19},
    {"id": 17, "type": "lesson", "name": "الاهداف"},
    {"id": 18, "type": "lesson", "name": "الدرس الاول"},
    {"id": 19, "type": "lesson", "name": "نشاط 1"},
    {"id": 20, "type": "lesson", "name": "الدرس الثانى"},
    {"id": 23, "type": "exam", "name": "اختبر نفسك"},
    {"id": 24, "type": "exam", "name": "امتحان الوحدة الثالث", "next_exam_index": 25},
    {"id": 21, "type": "lesson", "name": "الاهداف"},
    {"id": 22, "type": "lesson", "name": "الدرس الاول"},
    {"id": 23, "type": "lesson", "name": "نشاط 1"},
    {"id": 24, "type": "lesson", "name": "الدرس الثانى"},
    {"id": 25, "type": "lesson", "name": "نشاط 2"},
    {"id": 25, "type": "exam", "name": "امتحان الوحدة الرابعة"},
]
