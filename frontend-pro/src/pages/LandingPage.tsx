...
const LandingPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-white text-gray-800 transition-colors duration-300 dark:bg-gray-900 dark:text-gray-100">
      ...
      <header className="bg-primary relative z-10 flex max-h-[76px] min-h-[76px] items-center justify-between px-4 py-4 sm:px-6 dark:bg-primary">
            ...
            <div className="order-2 w-full space-y-10 pt-10 pb-10 text-center lg:order-1 lg:w-auto lg:space-y-20 lg:pt-25 lg:pr-50 lg:pb-50 lg:text-right">
              ...
              <div className="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-8 lg:justify-start">
                  ...
                  {/* Join Button */}
                  <button className="bg-primary relative z-10 transform rounded-xl px-6 py-3 font-semibold text-gray-800 shadow-lg transition-all duration-300 hover:scale-105 sm:px-8 sm:py-4 dark:bg-amber-300 dark:text-gray-900">
                    انضم إلينا
                  </button>
                </div>
              </div>
